             ...
             <div className="lg:w-1/2 p-8 lg:p-12 bg-amber-50/50">
                ...
                <form className="space-y-5">
                   <div>
                      ...
                      <input type="text" className="w-full bg-white border border-amber-200 rounded p-3 focus:border-primary focus:ring-1 focus:ring-primary outline-none" />
                   </div>
                   <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">Email:</label>
                      <input type="email" className="w-full bg-white border border-amber-200 rounded p-3 focus:border-primary focus:ring-1 focus:ring-primary outline-none" />
                   </div>
                   <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">Nội dung tin nhắn:</label>
                      <textarea rows={4} className="w-full bg-white border border-amber-200 rounded p-3 focus:border-primary focus:ring-1 focus:ring-primary outline-none"></textarea>
                   </div>
                   <button className="bg-secondary hover:bg-secondary-accent text-white font-bold py-3 px-8 rounded flex items-center transition-colors">
                      <Send size={16} className="mr-2" /> Gửi đi
                   </button>
                </form>
                ...
                <div className="mt-10 space-y-4 pt-8 border-t border-amber-200">
                   ...
                   <div className="flex items-start space-x-3">
                      ...
                      <div>
                         ...
                         <p className="text-sm text-gray-600">0877 2 788 255</p>
                      </div>
                   </div>
                   <div className="flex items-start space-x-3">
                      <div className="bg-secondary text-white p-2 rounded-full mt-1">
                      ...
                      <div>
                         ...
                         <p className="text-sm text-gray-600">mantiono@gmaficx.com</p>
                      </div>
                   </div>
                </div>
             </div>
